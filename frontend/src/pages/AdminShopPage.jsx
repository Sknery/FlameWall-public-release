    ...
    const handleFileChange = useCallback((event) => {
        ...
        if (isProfileFrame) {
            ...
            reader.addEventListener('load', () => { 
                console.log('✓ FileReader loaded for profile frame, result length:', reader.result?.toString().length);
                const dataUrl = reader.result?.toString() || '';
                console.log('✓ Setting imageToCrop and cropperOpen to true');
        ...
        console.log('✗ Not a profile frame, checking other conditions...');
